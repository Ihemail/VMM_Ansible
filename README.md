...
4. Open test editor and modify the `vmm-conf.yaml` file with your own userid:
 ...
 12          p4: userid@q-pod23-vmm.englab.juniper.net
 13          p5: userid@wf-pod01-vmm.englab.juniper.net
 14          p6: userid@q-pod21-vmm.englab.juniper.net
 15          p7: userid@q-pod22-vmm.englab.juniper.net
...
5. Exit from VMM Pod and execute the ansible-playbook:
  ...
  changed: [localhost] => (item=    ncpus 8;)
  changed: [localhost] => (item=    memory 8192;)
